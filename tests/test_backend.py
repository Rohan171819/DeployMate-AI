...
def test_deploy_message_case_insensitive():
    """Should detect deploy keyword regardless of case."""
    assert is_deploy_message("I want to DEPLOY my app") == True
...
def test_code_review_case_insensitive():
    """Should detect code review regardless of case."""
    assert is_code_review_message("REVIEW MY CODE please") == True
